...
// --- PRODUCTS - ONLY WOMEN KURTAS ---
$products = [
101=>["title"=>"Anouk Women Kurta Set","price"=>1199,"img"=>"images/w1.jpg","category"=>"Women","brand"=>"Anouk","description"=>"Elegant printed kurta set with palazzo and dupatta. Perfect for festive occasions and casual wear.", "sizes"=>["S","M","L","XL"], "colors"=>["Blue","Pink","Green"], "color_images"=>["Blue"=>"images/w1.jpg","Pink"=>"images/w1_pink.jpg","Green"=>"images/w1_green.jpg"]],
102=>["title"=>"Libas Embroidered Kurta","price"=>1999,"img"=>"images/w2.webp","category"=>"Women","brand"=>"Libas","description"=>"Beautiful embroidered kurta with intricate thread work and comfortable fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Red","Maroon","Black"], "color_images"=>["Red"=>"images/w2.webp","Maroon"=>"images/w2_maroon.jpg","Black"=>"images/w2_black.jpg"]],
103=>["title"=>"Biba Cotton Printed Kurta","price"=>899,"img"=>"images/w3.webp","category"=>"Women","brand"=>"Biba","description"=>"Pure cotton printed kurta with traditional motifs and comfortable fit.", "sizes"=>["S","M","L","XL"], "colors"=>["Yellow","Orange","White"], "color_images"=>["Yellow"=>"images/w3.webp","Orange"=>"images/w3_orange.jpg","White"=>"images/w3_white.jpg"]],
104=>["title"=>"W for Woman A-Line Kurta","price"=>749,"img"=>"images/w4.webp","category"=>"Women","brand"=>"W for Woman","description"=>"Stylish A-line kurta with contemporary design and elegant prints.", "sizes"=>["S","M","L","XL"], "colors"=>["Navy Blue","Grey","Purple"], "color_images"=>["Navy Blue"=>"images/w4.webp","Grey"=>"images/w4_grey.jpg","Purple"=>"images/w4_purple.jpg"]],
105=>["title"=>"Global Desi Mirror Work Kurta","price"=>3499,"img"=>"images/w5.jpg","category"=>"Women","brand"=>"Global Desi","description"=>"Luxurious mirror work kurta with ethnic designs and premium fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Pink","Gold","Silver"], "color_images"=>["Pink"=>"images/w5.jpg","Gold"=>"images/w5_gold.jpg","Silver"=>"images/w5_silver.jpg"]],
106=>["title"=>"Fabindia Handloom Kurta","price"=>1499,"img"=>"images/w6.webp","category"=>"Women","brand"=>"Fabindia","description"=>"Authentic handloom cotton kurta with traditional weaving patterns.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Beige","Brown"], "color_images"=>["White"=>"images/w6.webp","Beige"=>"images/w6_beige.jpg","Brown"=>"images/w6_brown.jpg"]],
107=>["title"=>"Soch Embellished Kurta","price"=>2499,"img"=>"images/w7.jpg","category"=>"Women","brand"=>"Soch","description"=>"Heavily embellished kurta with stone work and intricate embroidery.", "sizes"=>["S","M","L","XL"], "colors"=>["Black","Royal Blue","Burgundy"], "color_images"=>["Black"=>"images/w7.jpg","Royal Blue"=>"images/w7_blue.jpg","Burgundy"=>"images/w7_burgundy.jpg"]],
108=>["title"=>"Manyavar Silk Kurta Set","price"=>4999,"img"=>"images/w8.jpg","category"=>"Women","brand"=>"Manyavar","description"=>"Premium silk kurta set with detailed embroidery and matching bottom.", "sizes"=>["S","M","L","XL"], "colors"=>["Cream","Gold","Maroon"], "color_images"=>["Cream"=>"images/w8.jpg","Gold"=>"images/w8_gold.jpg","Maroon"=>"images/w8_maroon.jpg"]],
109=>["title"=>"H&M Casual Cotton Kurta","price"=>499,"img"=>"images/w9.jpeg","category"=>"Women","brand"=>"H&M","description"=>"Casual everyday wear cotton kurta with minimalist design.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Black","Grey"], "color_images"=>["White"=>"images/w9.jpeg","Black"=>"images/w9_black.jpg","Grey"=>"images/w9_grey.jpg"]],
110=>["title"=>"Zara Contemporary Kurta","price"=>1999,"img"=>"images/w10.webp","category"=>"Women","brand"=>"Zara","description"=>"Contemporary style kurta with modern cuts and trendy patterns.", "sizes"=>["S","M","L","XL"], "colors"=>["Olive Green","Mustard","Teal"], "color_images"=>["Olive Green"=>"images/w10.webp","Mustard"=>"images/w10_mustard.jpg","Teal"=>"images/w10_teal.jpg"]],
111=>["title"=>"M&S Premium Linen Kurta","price"=>1299,"img"=>"images/w11.webp","category"=>"Women","brand"=>"Marks & Spencer","description"=>"Premium linen kurta perfect for summer with breathable fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Light Blue","Peach","Mint"], "color_images"=>["Light Blue"=>"images/w11.webp","Peach"=>"images/w11_peach.jpg","Mint"=>"images/w11_mint.jpg"]],
112=>["title"=>"Anouk Party Wear Kurta","price"=>999,"img"=>"images/w12.webp","category"=>"Women","brand"=>"Anouk","description"=>"Party wear kurta with heavy work and elegant silhouette.", "sizes"=>["S","M","L","XL"], "colors"=>["Silver","Bronze","Rose Gold"], "color_images"=>["Silver"=>"images/w12.webp","Bronze"=>"images/w12_bronze.jpg","Rose Gold"=>"images/w12_rosegold.jpg"]],
113=>["title"=>"Biba Kids Kurta Set","price"=>799,"img"=>"images/w13.webp","category"=>"Kids","brand"=>"Biba","description"=>"Adorable kids kurta set with fun prints and comfortable fabric.", "sizes"=>["2-3Y","4-5Y","6-7Y"], "colors"=>["Pink","Blue","Yellow"], "color_images"=>["Pink"=>"images/w13.webp","Blue"=>"images/w13_blue.jpg","Yellow"=>"images/w13_yellow.jpg"]],
114=>["title"=>"W for Woman Daily Wear Kurta","price"=>599,"img"=>"images/w14.jpg","category"=>"Women","brand"=>"W for Woman","description"=>"Comfortable daily wear kurta with simple yet elegant design.", "sizes"=>["S","M","L","XL"], "colors"=>["Light Pink","Sky Blue","Lavender"], "color_images"=>["Light Pink"=>"images/w14.jpg","Sky Blue"=>"images/w14_blue.jpg","Lavender"=>"images/w14_lavender.jpg"]],
115=>["title"=>"Libas Festive Kurta Set","price"=>1799,"img"=>"images/w15.jpg","category"=>"Women","brand"=>"Libas","description"=>"Festive kurta set with elaborate work and rich fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Red","Green","Purple"], "color_images"=>["Red"=>"images/w15.jpg","Green"=>"images/w15_green.jpg","Purple"=>"images/w15_purple.jpg"]],
116=>["title"=>"Global Desi Bohemian Kurta","price"=>1399,"img"=>"images/w16.webp","category"=>"Women","brand"=>"Global Desi","description"=>"Bohemian style kurta with ethnic prints and flowy silhouette.", "sizes"=>["S","M","L","XL"], "colors"=>["Multicolor","Blue","Orange"], "color_images"=>["Multicolor"=>"images/w16.webp","Blue"=>"images/w16_blue.jpg","Orange"=>"images/w16_orange.jpg"]],
117=>["title"=>"Soch Traditional Kurta","price"=>1799,"img"=>"images/w17.jpg","category"=>"Women","brand"=>"Soch","description"=>"Traditional kurta with authentic Indian designs and craftsmanship.", "sizes"=>["S","M","L","XL"], "colors"=>["Red","Blue","Green"], "color_images"=>["Red"=>"images/w17.jpg","Blue"=>"images/w17_blue.jpg","Green"=>"images/w17_green.jpg"]],
118=>["title"=>"Fabindia Organic Cotton Kurta","price"=>1399,"img"=>"images/w18.webp","category"=>"Women","brand"=>"Fabindia","description"=>"Organic cotton kurta with natural dyes and sustainable fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Natural","Off-White","Terracotta"], "color_images"=>["Natural"=>"images/w18.webp","Off-White"=>"images/w18_offwhite.jpg","Terracotta"=>"images/w18_terracotta.jpg"]],
119=>["title"=>"Manyavar Wedding Kurta Set","price"=>2999,"img"=>"images/w19.jpg","category"=>"Women","brand"=>"Manyavar","description"=>"Grand wedding kurta set with heavy embroidery and luxurious fabric.", "sizes"=>["S","M","L","XL"], "colors"=>["Red","Gold","Pink"], "color_images"=>["Red"=>"images/w19.jpg","Gold"=>"images/w19_gold.jpg","Pink"=>"images/w19_pink.jpg"]],
120=>["title"=>"H&M Printed Maxi Kurta","price"=>1899,"img"=>"images/w20.jpg","category"=>"Women","brand"=>"H&M","description"=>"Maxi length kurta with beautiful prints and comfortable fit.", "sizes"=>["S","M","L","XL"], "colors"=>["Black","White","Navy"], "color_images"=>["Black"=>"images/w20.jpg","White"=>"images/w20_white.jpg","Navy"=>"images/w20_navy.jpg"]],
121=>["title"=>"Zara Designer Kurta","price"=>899,"img"=>"images/w21.webp","category"=>"Women","brand"=>"Zara","description"=>"Designer kurta with unique patterns and modern aesthetics.", "sizes"=>["S","M","L","XL"], "colors"=>["Grey","Brown","Blue"], "color_images"=>["Grey"=>"images/w21.webp","Brown"=>"images/w21_brown.jpg","Blue"=>"images/w21_blue.jpg"]],
122=>["title"=>"Anouk Office Wear Kurta","price"=>2599,"img"=>"images/w22.jpeg","category"=>"Women","brand"=>"Anouk","description"=>"Professional office wear kurta with sophisticated design.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Black","Navy"], "color_images"=>["White"=>"images/w22.jpeg","Black"=>"images/w22_black.jpg","Navy"=>"images/w22_navy.jpg"]],
123=>["title"=>"Biba Summer Kurta","price"=>999,"img"=>"images/w23.webp","category"=>"Women","brand"=>"Biba","description"=>"Light summer kurta with breathable fabric and vibrant colors.", "sizes"=>["S","M","L","XL"], "colors"=>["Yellow","Orange","Pink"], "color_images"=>["Yellow"=>"images/w23.webp","Orange"=>"images/w23_orange.jpg","Pink"=>"images/w23_pink.jpg"]],
124=>["title"=>"W for Woman Casual Kurta","price"=>299,"img"=>"images/w24.jpg","category"=>"Women","brand"=>"W for Woman","description"=>"Casual everyday kurta with comfortable fit and easy maintenance.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Blue","Green"], "color_images"=>["White"=>"images/w24.jpg","Blue"=>"images/w24_blue.jpg","Green"=>"images/w24_green.jpg"]],
125=>["title"=>"Libas Designer Kurta Set","price"=>10999,"img"=>"images/w25.webp","category"=>"Women","brand"=>"Libas","description"=>"Premium designer kurta set with intricate detailing.", "sizes"=>["S","M","L","XL"], "colors"=>["Maroon","Blue","Green"], "color_images"=>["Maroon"=>"images/w25.webp","Blue"=>"images/w25_blue.jpg","Green"=>"images/w25_green.jpg"]],
126=>["title"=>"Global Desi Festive Kurta","price"=>1299,"img"=>"images/w26.jpg","category"=>"Women","brand"=>"Global Desi","description"=>"Festive kurta with contemporary ethnic designs.", "sizes"=>["S","M","L","XL"], "colors"=>["Red","Gold","Purple"], "color_images"=>["Red"=>"images/w26.jpg","Gold"=>"images/w26_gold.jpg","Purple"=>"images/w26_purple.jpg"]],
127=>["title"=>"Soch Party Kurta","price"=>2499,"img"=>"images/w27.webp","category"=>"Women","brand"=>"Soch","description"=>"Elegant party wear kurta with sophisticated embroidery.", "sizes"=>["S","M","L","XL"], "colors"=>["Black","Navy","Burgundy"], "color_images"=>["Black"=>"images/w27.webp","Navy"=>"images/w27_navy.jpg","Burgundy"=>"images/w27_burgundy.jpg"]],
128=>["title"=>"W for Woman Printed Kurti","price"=>1499,"img"=>"images/w29.webp","category"=>"Women","brand"=>"W for Woman","description"=>"Beautiful printed kurti with comfortable fit and stylish design.", "sizes"=>["S","M","L","XL"], "colors"=>["Pink","Blue","Yellow"], "color_images"=>["Pink"=>"images/w29.webp","Blue"=>"images/w29_blue.jpg","Yellow"=>"images/w29_yellow.jpg"]],
];
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title">Women Kurtas Collection</h1>
        <p class="page-subtitle">Discover the latest trends in ethnic wear from top brands</p>
    </div>
</div>
...
<div class="container my-4">
    <a href="?" class="back-to-products"><i class="fa fa-arrow-left"></i> Back to All Kurtas</a>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="d-flex mt-3 flex-wrap">
                    ...
                    ?>
                    <img src="<?= $image ?>" class="me-2 mb-2" width="60" height="60" style="cursor: pointer; border: 2px solid #ddd; border-radius: 5px;" 
            ...
            <div class="col-md-6">
                ...
                <div class="kurta-features">
                    ...
                    <div class="feature-item">
                        ...
                        <span>Beautiful prints and elegant designs</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-cut feature-icon"></i>
                        <span>Perfect fit with comfortable silhouette</span>
                    </div>
                    <div class="feature-item">
                ...
                <div class="product-detail-specs">
                    ...
                    <div class="spec-item">
                        ...
                        <div class="spec-value"><?= $currentProduct['category'] ?> Kurtas</div>
                    </div>
