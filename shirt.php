...
// --- MEN SHIRTS SECTION (Total 132 IDs, same numbers retained) ---
$products = [
101=>["title"=>"Louis Philippe Formal Cotton Shirt","price"=>1999,"img"=>"images/n1.jpg","category"=>"Men","brand"=>"Louis Philippe","description"=>"Premium cotton formal shirt with perfect fit. Ideal for office wear and formal occasions.", "sizes"=>["38","40","42","44"], "colors"=>["White","Blue","Pink"]],
102=>["title"=>"Allen Solly Slim Fit Formal Shirt","price"=>1799,"img"=>"images/n2.jpg","category"=>"Men","brand"=>"Allen Solly","description"=>"Slim fit formal shirt with contemporary styling. Perfect for business meetings and corporate events.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Blue","Grey"]],
103=>["title"=>"Peter England Premium Formal Shirt","price"=>2199,"img"=>"images/n3.jpg","category"=>"Men","brand"=>"Peter England","description"=>"Luxury premium shirt with superior fabric quality. For the sophisticated gentleman.", "sizes"=>["38","40","42","44"], "colors"=>["White","Blue","Grey"]],
104=>["title"=>"Roadster Checked Casual Shirt","price"=>999,"img"=>"images/n4.jpg","category"=>"Men","brand"=>"Roadster","description"=>"Trendy checked shirt from Roadster. Perfect for casual outings and college wear.", "sizes"=>["S","M","L","XL"], "colors"=>["Red Check","Blue Check","Black Check"]],
105=>["title"=>"Levi's Denim Casual Shirt","price"=>2499,"img"=>"images/n5.webp","category"=>"Men","brand"=>"Levi's","description"=>"Classic denim shirt from Levi's. Durable and stylish for casual occasions.", "sizes"=>["S","M","L","XL"], "colors"=>["Light Blue","Dark Blue","Black"]],
106=>["title"=>"Arrow Classic White Shirt","price"=>1899,"img"=>"images/n6.jpg","category"=>"Men","brand"=>"Arrow","description"=>"Classic white formal shirt from Arrow. Timeless design for professional settings.", "sizes"=>["38","40","42","44"], "colors"=>["White"]],
107=>["title"=>"Van Heusen Striped Formal Shirt","price"=>2299,"img"=>"images/n7.webp","category"=>"Men","brand"=>"Van Heusen","description"=>"Elegant striped formal shirt. Combines style with professional appeal.", "sizes"=>["S","M","L","XL"], "colors"=>["Blue Stripes","Grey Stripes","Pink Stripes"]],
108=>["title"=>"Blackberrys Plain Blue Shirt","price"=>1999,"img"=>"images/n8.jpg","category"=>"Men","brand"=>"Blackberrys","description"=>"Premium plain blue shirt with superior finish. Ideal for boardroom meetings.", "sizes"=>["38","40","42","44"], "colors"=>["Blue","Light Blue","Navy"]],
109=>["title"=>"Park Avenue Slim Fit Shirt","price"=>2399,"img"=>"images/n9.webp","category"=>"Men","brand"=>"Park Avenue","description"=>"Slim fit shirt with contemporary styling. Perfect for modern professionals.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Blue","Grey"]],
110=>["title"=>"U.S. Polo Assn. Checked Shirt","price"=>1699,"img"=>"images/n10.jpg","category"=>"Men","brand"=>"U.S. Polo Assn.","description"=>"Casual checked shirt with polo branding. Sporty yet sophisticated look.", "sizes"=>["S","M","L","XL"], "colors"=>["Red Check","Blue Check","Green Check"]],
111=>["title"=>"Mufti Cotton Casual Shirt","price"=>1499,"img"=>"images/n11.jpg","category"=>"Men","brand"=>"Mufti","description"=>"Comfortable cotton casual shirt for everyday wear. Easy to maintain and style.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Black","Navy"]],
112=>["title"=>"Indian Terrain Linen Shirt","price"=>1899,"img"=>"images/n12.jpg","category"=>"Men","brand"=>"Indian Terrain","description"=>"Breathable linen shirt perfect for summer. Comfortable and stylish.", "sizes"=>["S","M","L","XL"], "colors"=>["Beige","White","Blue"]],
113=>["title"=>"Raymond Solid Formal Shirt","price"=>2599,"img"=>"images/n13.jpg","category"=>"Men","brand"=>"Raymond","description"=>"Premium solid formal shirt from Raymond. Exceptional quality and finish.", "sizes"=>["38","40","42","44"], "colors"=>["White","Blue","Grey"]],
114=>["title"=>"Jack & Jones Chambray Shirt","price"=>1999,"img"=>"images/n14.jpg","category"=>"Men","brand"=>"Jack & Jones","description"=>"Stylish chambray shirt with modern fit. Perfect for casual Fridays.", "sizes"=>["S","M","L","XL"], "colors"=>["Light Blue","Dark Blue","Grey"]],
115=>["title"=>"Tommy Hilfiger Oxford Shirt","price"=>3499,"img"=>"images/n15.webp","category"=>"Men","brand"=>"Tommy Hilfiger","description"=>"Classic Oxford shirt with brand signature. Premium quality and iconic style.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Blue","Pink"]],
116=>["title"=>"United Colors of Benetton Striped Shirt","price"=>1799,"img"=>"images/n16.webp","category"=>"Men","brand"=>"UCB","description"=>"Colorful striped shirt from Benetton. Vibrant and fashionable.", "sizes"=>["S","M","L","XL"], "colors"=>["Multicolor Stripes","Blue Stripes","Red Stripes"]],
117=>["title"=>"H&M Cotton Casual Shirt","price"=>1499,"img"=>"images/n17.webp","category"=>"Men","brand"=>"H&M","description"=>"Affordable cotton casual shirt. Great for everyday casual wear.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Black","Blue"]],
118=>["title"=>"Allen Solly Polo T-Shirt","price"=>1399,"img"=>"images/n18.jpg","category"=>"Men","brand"=>"Allen Solly","description"=>"Classic polo t-shirt from Allen Solly. Premium quality for casual and semi-formal wear.", "sizes"=>["S","M","L","XL"], "colors"=>["Blue","Green","Red"]],
119=>["title"=>"Van Heusen Textured Shirt","price"=>1899,"img"=>"images/n19.jpg","category"=>"Men","brand"=>"Van Heusen","description"=>"Textured formal shirt with unique finish. Adds dimension to your formal wardrobe.", "sizes"=>["38","40","42","44"], "colors"=>["White","Blue","Grey"]],
120=>["title"=>"Arrow Linen Blend Shirt","price"=>2199,"img"=>"images/n20.jpg","category"=>"Men","brand"=>"Arrow","description"=>"Linen blend shirt for comfort and style. Perfect for summer formal wear.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Blue","Beige"]],
121=>["title"=>"Peter England Checked Cotton Shirt","price"=>1699,"img"=>"images/n21.webp","category"=>"Men","brand"=>"Peter England","description"=>"Checked cotton shirt for casual occasions. Comfortable and stylish.", "sizes"=>["S","M","L","XL"], "colors"=>["Blue Check","Red Check","Green Check"]],
122=>["title"=>"Roadster Printed Casual Shirt","price"=>1199,"img"=>"images/n22.jpg","category"=>"Men","brand"=>"Roadster","description"=>"Printed casual shirt with trendy patterns. Express your style with unique prints.", "sizes"=>["S","M","L","XL"], "colors"=>["Printed Blue","Printed Black","Printed Red"]],
123=>["title"=>"HRX Activewear Dry-Fit Shirt","price"=>1599,"img"=>"images/n23.jpg","category"=>"Men","brand"=>"HRX","description"=>"Performance dry-fit shirt with moisture-wicking technology. Perfect for workouts and sports.", "sizes"=>["S","M","L","XL"], "colors"=>["Black","Blue","Red"]],
124=>["title"=>"Bewakoof Graphic T-Shirt","price"=>999,"img"=>"images/n24.jpg","category"=>"Men","brand"=>"Bewakoof","description"=>"Cool graphic printed t-shirt with trendy designs. Express your style with unique prints.", "sizes"=>["S","M","L","XL"], "colors"=>["White","Black","Grey"]],
];
...
<head>
    ...
    <title><?= $currentProduct ? $currentProduct['title'] . ' - Myntra Clone' : 'Men Shirts - Myntra Clone' ?></title>
...
<div class="page-header">
    <div class="container">
        ...
        <h1 class="page-title">Men's Shirts</h1>
        <p class="page-subtitle">Discover the latest collection of formal and casual shirts for men</p>
    </div>
</div>
...
<div class="container my-4">
    <a href="shirt.php" class="back-to-products"><i class="fa fa-arrow-left"></i> Back to Shirts</a>
        ...
        >
            <div class="card product-card">
                ...
                <div class="product-details">
                    ...
                    <div class="product-size">Sizes: <?= implode(', ', $p['sizes']) ?></div>
