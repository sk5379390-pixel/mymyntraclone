...
$products = [
    101 => [
        ...
        "category" => "Skincare",
        "brand" => "Anouk",
        "description" => "Deeply hydrating face moisturizer with hyaluronic acid. Provides 24-hour moisture, improves skin elasticity, and leaves skin soft and supple. Suitable for all skin types.",
        "sizes" => ["50ml", "100ml", "200ml"],
        "skin_types" => ["All Skin Types", "Dry Skin", "Combination Skin"],
        "benefits" => ["Deep Hydration", "Improves Elasticity", "Non-Greasy", "24-Hour Moisture"],
        "ingredients" => ["Hyaluronic Acid", "Ceramides", "Vitamin E", "Aloe Vera"],
        "color_images" => [
            "Original" => "images/sk1.jpg",
            "With SPF" => "images/sk1.jpg",
            "Extra Hydration" => "images/sk1.jpg"
        ]
    ],
    102 => [
        ...
        "description" => "Potent Vitamin C serum that brightens skin, reduces dark spots, and evens out skin tone. Contains antioxidants to protect against environmental damage.",
        "sizes" => ["30ml", "50ml", "75ml"],
        "skin_types" => ["Dull Skin", "Aging Skin", "Uneven Skin Tone"],
        "benefits" => ["Brightens Skin", "Reduces Dark Spots", "Even Skin Tone", "Antioxidant Protection"],
        "ingredients" => ["Vitamin C", "Ferulic Acid", "Vitamin E", "Hyaluronic Acid"],
        "color_images" => [
            "Original" => "images/sk2.jpg",
            "Extra Strength" => "images/sk2.jpg",
            "With Hyaluronic Acid" => "images/sk2.jpg"
        ]
    ],
    103 => [
        ...
        "category" => "Skincare",
        "brand" => "White Shirt",
        "description" => "Pure aloe vera gel that soothes irritated skin, reduces inflammation, and provides instant hydration. Perfect for sunburn, acne, and sensitive skin.",
        "sizes" => ["100ml", "200ml", "500ml"],
        "skin_types" => ["Sensitive Skin", "Oily Skin", "Acne-Prone Skin"],
        "benefits" => ["Soothes Skin", "Reduces Inflammation", "Hydrates", "Non-Comedogenic"],
        "ingredients" => ["Pure Aloe Vera", "Vitamin E", "Allantoin", "Chamomile Extract"],
        "color_images" => [
            "Original" => "images/sk3.jpg",
            "With Vitamin E" => "images/sk3.jpg",
            "Cooling Formula" => "images/sk3.jpg"
        ]
    ],
    104 => [
        ...
        "category" => "Skincare",
        "brand" => "Roadster",
        "description" => "Deep cleansing charcoal face wash that draws out impurities, excess oil, and toxins from pores. Leaves skin feeling fresh and revitalized.",
        "sizes" => ["100ml", "150ml", "200ml"],
        "skin_types" => ["Oily Skin", "Combination Skin", "Acne-Prone Skin"],
        "benefits" => ["Deep Cleansing", "Oil Control", "Pore Minimizing", "Detoxifying"],
        "ingredients" => ["Activated Charcoal", "Tea Tree Oil", "Salicylic Acid", "Menthol"],
        "color_images" => [
            "Original" => "images/sk4.jpg",
            "With Tea Tree" => "images/sk4.jpg",
            "Extra Strength" => "images/sk4.jpg"
        ]
    ],
    105 => [
        ...
        "category" => "Skincare",
        "brand" => "Peter England",
        "description" => "Luxurious anti-aging night cream that works while you sleep to reduce fine lines, wrinkles, and improve skin firmness and elasticity.",
        "sizes" => ["50ml", "75ml", "100ml"],
        "skin_types" => ["Mature Skin", "Dry Skin", "Aging Skin"],
        "benefits" => ["Reduces Wrinkles", "Improves Firmness", "Boosts Elasticity", "Overnight Repair"],
        "ingredients" => ["Retinol", "Peptides", "Niacinamide", "Ceramides"],
        "color_images" => [
            "Original" => "images/sk5.jpg",
            "Extra Rich" => "images/sk5.jpg",
            "With Retinol" => "images/sk5.jpg"
        ]
    ],
    106 => [
        "title" => "Sunscreen SPF 50 Lotion",
        "price" => 1499,
        "img" => "images/sk6.jpg",
        "category" => "Skincare",
        "brand" => "Adidas",
        "description" => "Broad spectrum SPF 50 sunscreen that provides superior protection against UVA/UVB rays. Lightweight, non-greasy formula suitable for daily use.",
        "sizes" => ["50ml", "100ml", "150ml"],
        "skin_types" => ["All Skin Types", "Sensitive Skin", "Oily Skin"],
        "benefits" => ["UVA/UVB Protection", "Water Resistant", "Non-Greasy", "Lightweight"],
        "ingredients" => ["Zinc Oxide", "Titanium Dioxide", "Vitamin E", "Aloe Vera"],
        "color_images" => [
            "Original" => "images/sk6.jpg",
            "Matte Finish" => "images/sk6.jpg",
            "Tinted" => "images/sk6.jpg"
        ]
    ],
    107 => [
        ...
        "category" => "Skincare",
        "brand" => "Levi's",
        "description" => "Purifying clay mask that draws out impurities, excess oil, and toxins from deep within pores. Leaves skin feeling clean, refreshed, and revitalized.",
        "sizes" => ["100ml", "150ml", "200ml"],
        "skin_types" => ["Oily Skin", "Combination Skin", "Acne-Prone Skin"],
        "benefits" => ["Deep Cleansing", "Pore Purifying", "Oil Control", "Skin Detox"],
        "ingredients" => ["Bentonite Clay", "Kaolin Clay", "Charcoal", "Tea Tree Oil"],
        "color_images" => [
            "Original" => "images/sk7.jpg",
            "With Charcoal" => "images/sk7.jpg",
            "Extra Strength" => "images/sk7.jpg"
        ]
    ],
    108 => [
        ...
        "category" => "Skincare",
        "brand" => "Manyavar",
        "description" => "Refreshing herbal toner that balances skin pH, tightens pores, and prepares skin for better absorption of serums and moisturizers.",
        "sizes" => ["100ml", "200ml", "300ml"],
        "skin_types" => ["All Skin Types", "Sensitive Skin", "Combination Skin"],
        "benefits" => ["Balances pH", "Tightens Pores", "Refreshes Skin", "Hydrates"],
        "ingredients" => ["Rose Water", "Witch Hazel", "Aloe Vera", "Chamomile"],
        "color_images" => [
            "Original" => "images/sk8.webp",
            "Rose Formula" => "images/sk8.webp",
            "With Witch Hazel" => "images/sk8.webp"
        ]
    ],
    109 => [
        "title" => "Brightening Face Scrub",
        "price" => 1299,
        "img" => "https://images.unsplash.com/photo-1590412200988-a0e48b1300da?w=500&h=500&fit=crop",
        "category" => "Skincare",
        "brand" => "Lakmé",
        "description" => "Gentle exfoliating scrub with natural beads that remove dead skin cells, unclog pores, and reveal brighter, smoother skin.",
        "sizes" => ["75ml", "125ml", "200ml"],
        "skin_types" => ["All Skin Types", "Dull Skin", "Combination Skin"],
        "benefits" => ["Exfoliates", "Brightens Skin", "Unclogs Pores", "Smooths Texture"],
        "ingredients" => ["Jojoba Beads", "Vitamin C", "Almond Oil", "Green Tea Extract"],
        "color_images" => [
            "Original" => "https://images.unsplash.com/photo-1590412200988-a0e48b1300da?w=500&h=500&fit=crop",
            "Extra Gentle" => "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=500&h=500&fit=crop",
            "With Vitamin C" => "https://images.unsplash.com/photo-1590412200988-a0e48b1300da?w=500&h=500&fit=crop"
        ]
    ],
    110 => [
        "title" => "Under Eye Cream",
        "price" => 2199,
        "img" => "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=500&h=500&fit=crop",
        "category" => "Skincare",
        "brand" => "Maybelline",
        "description" => "Specialized under eye cream that reduces dark circles, puffiness, and fine lines. Formulated with caffeine and vitamin K for visible results.",
        "sizes" => ["15ml", "30ml", "50ml"],
        "skin_types" => ["All Skin Types", "Sensitive Skin"],
        "benefits" => ["Reduces Dark Circles", "Minimizes Puffiness", "Hydrates", "Anti-Aging"],
        "ingredients" => ["Caffeine", "Vitamin K", "Hyaluronic Acid", "Peptides"],
        "color_images" => [
            "Original" => "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=500&h=500&fit=crop",
            "Extra Strength" => "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=500&h=500&fit=crop",
            "With Caffeine" => "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=500&h=500&fit=crop"
        ]
    ],
    111 => [
        "title" => "Acne Control Gel",
        "price" => 899,
        "img" => "https://images.unsplash.com/photo-1631217868264-e5b90bb7e138?w=500&h=500&fit=crop",
        "category" => "Skincare",
        "brand" => "Garnier",
        "description" => "Fast-acting acne control gel with salicylic acid that targets breakouts, reduces inflammation, and prevents future acne formation.",
        "sizes" => ["30ml", "50ml", "75ml"],
        "skin_types" => ["Acne-Prone Skin", "Oily Skin", "Combination Skin"],
        "benefits" => ["Targets Breakouts", "Reduces Inflammation", "Prevents Acne", "Oil Control"],
        "ingredients" => ["Salicylic Acid", "Tea Tree Oil", "Niacinamide", "Zinc"],
        "color_images" => [
            "Original" => "https://images.unsplash.com/photo-1631217868264-e5b90bb7e138?w=500&h=500&fit=crop",
            "Extra Strength" => "https://images.unsplash.com/photo-1590412200988-a0e48b1300da?w=500&h=500&fit=crop",
            "With Tea Tree" => "https://images.unsplash.com/photo-1631217868264-e5b90bb7e138?w=500&h=500&fit=crop"
        ]
    ],
    112 => [
        "title" => "Overnight Repair Serum",
        "price" => 2999,
        "img" => "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=500&h=500&fit=crop",
        "category" => "Skincare",
        "brand" => "L'Oreal",
        "description" => "Powerful overnight repair serum that works while you sleep to rejuvenate skin, repair damage, and wake up to glowing, refreshed skin.",
        "sizes" => ["30ml", "50ml", "75ml"],
        "skin_types" => ["All Skin Types", "Aging Skin", "Dull Skin"],
        "benefits" => ["Overnight Repair", "Skin Rejuvenation", "Brightens", "Anti-Aging"],
        "ingredients" => ["Retinol", "Hyaluronic Acid", "Peptides", "Niacinamide"],
        "color_images" => [
            "Original" => "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=500&h=500&fit=crop",
            "Extra Repair" => "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=500&h=500&fit=crop",
            "With Retinol" => "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=500&h=500&fit=crop"
        ]
    ]
];
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title">Skincare Collection</h1>
        <p class="page-subtitle">Discover premium skincare products for healthy, glowing skin</p>
    </div>
</div>
