...
$products = [
    501=>[
        ...
        "category"=>"Cookware",
        "brand"=>"Kitchen Elite",
        "description"=>"Premium non-stick cookware set with durable coating. Includes frying pans, saucepans, and lids. Perfect for everyday cooking with easy cleanup.",
        "sizes"=>["5-Piece Set","7-Piece Set","10-Piece Set"],
        "colors"=>["Black","Red","Silver"],
        "color_images"=>[
            "Black"=>"images/kitchen1.jpg",
            "Red"=>"images/kitchen2.jpg",
            "Silver"=>"images/kitchen3.jpg"
        ]
    ],
    502=>[
        "title"=>"Stainless Steel Mixer Grinder",
        "price"=>2499,
        "img"=>"images/k2.jpeg",
        "category"=>"Appliances",
        "brand"=>"Power Grind",
        "description"=>"Heavy-duty stainless steel mixer grinder with multiple jars. Perfect for grinding, blending, and juicing with powerful motor and safety features.",
        "sizes"=>["500W","750W","1000W"],
        "colors"=>["Silver","Black","White"],
        "color_images"=>[
            "Silver"=>"images/kitchen2.jpg",
            "Black"=>"images/kitchen1.jpg",
            "White"=>"images/kitchen3.jpg"
        ]
    ],
    503=>[
        ...
        "category"=>"Dining",
        "brand"=>"Elegant Table",
        "description"=>"Beautiful ceramic dinnerware set with modern design. Includes plates, bowls, and mugs. Microwave and dishwasher safe for everyday use.",
        "sizes"=>["16-Piece Set","24-Piece Set","32-Piece Set"],
        "colors"=>["White","Blue","Cream"],
        "color_images"=>[
            "White"=>"images/kitchen3.jpg",
            "Blue"=>"images/kitchen1.jpg",
            "Cream"=>"images/kitchen2.jpg"
        ]
    ],
    504=>[
        ...
        "category"=>"Storage",
        "brand"=>"Fresh Store",
        "description"=>"Set of glass storage containers with airtight lids. Perfect for storing dry foods, leftovers, and meal prep. Microwave and freezer safe.",
        "sizes"=>["5-Piece Set","10-Piece Set","15-Piece Set"],
        "colors"=>["Clear","Blue Tint","Smoke"],
        "color_images"=>[
            "Clear"=>"images/kitchen4.jpg",
            "Blue Tint"=>"images/kitchen1.jpg",
            "Smoke"=>"images/kitchen2.jpg"
        ]
    ],
    505=>[
        ...
        "category"=>"Utensils",
        "brand"=>"Natural Wood",
        "description"=>"Set of bamboo cutting boards in different sizes. Eco-friendly, durable, and gentle on knives. Perfect for all your chopping needs.",
        "sizes"=>["3-Piece Set","5-Piece Set","7-Piece Set"],
        "colors"=>["Natural","Dark Wood","Mixed"],
        "color_images"=>[
            "Natural"=>"images/kitchen5.jpg",
            "Dark Wood"=>"images/kitchen1.jpg",
            "Mixed"=>"images/kitchen2.jpg"
        ]
    ],
    506=>[
        ...
        "category"=>"Appliances",
        "brand"=>"Quick Boil",
        "description"=>"Stainless steel electric kettle with automatic shut-off. Fast boiling with 1.5L capacity. Perfect for tea, coffee, and instant foods.",
        "sizes"=>["1.0L","1.5L","1.8L"],
        "colors"=>["Stainless Steel","Black","Red"],
        "color_images"=>[
            "Stainless Steel"=>"images/kitchen6.jpg",
            "Black"=>"images/kitchen1.jpg",
            "Red"=>"images/kitchen2.jpg"
        ]
    ],
    507=>[
        ...
        "category"=>"Cutlery",
        "brand"=>"Sharp Edge",
        "description"=>"Professional kitchen knife set with high-carbon stainless steel blades. Includes chef knife, paring knife, bread knife and storage block.",
        "sizes"=>["5-Piece Set","7-Piece Set","10-Piece Set"],
        "colors"=>["Black","Silver","Wood"],
        "color_images"=>[
            "Black"=>"images/kitchen7.jpg",
            "Silver"=>"images/kitchen1.jpg",
            "Wood"=>"images/kitchen2.jpg"
        ]
    ],
    508=>[
        ...
        "category"=>"Utensils",
        "brand"=>"Flexi Cook",
        "description"=>"Set of heat-resistant silicone cooking utensils. Includes spatula, spoon, whisk, and turner. Safe for non-stick cookware and easy to clean.",
        "sizes"=>["4-Piece Set","6-Piece Set","8-Piece Set"],
        "colors"=>["Black","Red","Multicolor"],
        "color_images"=>[
            "Black"=>"images/kitchen8.jpg",
            "Red"=>"images/kitchen1.jpg",
            "Multicolor"=>"images/kitchen2.jpg"
        ]
    ],
    509=>[
        "title"=>"Air Fryer",
        ...
        "category"=>"Appliances",
        "brand"=>"Healthy Fry",
        "description"=>"Digital air fryer with multiple cooking functions. Cook crispy food with up to 80% less oil. Perfect for healthy frying, baking, and grilling.",
        "sizes"=>["3.5L","5.0L","6.5L"],
        "colors"=>["Black","Silver","White"],
        "color_images"=>[
            "Black"=>"images/ar.jpg",
            "Silver"=>"images/ar.jpg",
            "White"=>"images/ar.jpg"
        ]
    ],
    510=>[
        ...
        "category"=>"Storage",
        "brand"=>"Spice Master",
        "description"=>"Wooden spice rack organizer with 12 glass jars. Keep your spices organized and easily accessible. Perfect for countertop or wall mounting.",
        "sizes"=>["12 Jars","18 Jars","24 Jars"],
        "colors"=>["Bamboo","Dark Wood","White"],
        "color_images"=>[
            "Bamboo"=>"images/sb.jpg",
            "Dark Wood"=>"images/dw.jpg",
            "White"=>"images/spice.jpg"
        ]
    ],
    511=>[
        "title"=>"Coffee Maker",
        ...
        "category"=>"Appliances",
        "brand"=>"Brew Perfect",
        "description"=>"Programmable coffee maker with thermal carafe. Brews up to 12 cups with adjustable strength. Perfect for morning coffee routine.",
        "sizes"=>["8-Cup","10-Cup","12-Cup"],
        "colors"=>["Black","Stainless Steel","Red"],
        "color_images"=>[
            "Black"=>"images/bk.webp",
            "Stainless Steel"=>"images/k11.webp",
            "Red"=>"images/kitchen.jpg"
        ]
    ],
    512=>[
        ...
        "category"=>"Linens",
        "brand"=>"Absorb Plus",
        "description"=>"Set of highly absorbent kitchen towels. Made from premium cotton with beautiful patterns. Perfect for drying hands and cleaning spills.",
        "sizes"=>["4-Piece Set","6-Piece Set","8-Piece Set"],
        "colors"=>["Striped","Floral","Solid"],
        "color_images"=>[
            "Striped"=>"images/k12.jpg",
            "Floral"=>"images/k12.jpg",
            "Solid"=>"images/k12.jpg"
        ]
    ]
];
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title">Kitchen Collection</h1>
        <p class="page-subtitle">Upgrade your kitchen with premium cookware, appliances and accessories</p>
    </div>
</div>
