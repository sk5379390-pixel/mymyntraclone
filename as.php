...
// --- PRODUCTS - GEN-Z ACCESSORIES COLLECTION ---
// --- PRODUCTS - GEN-Z ACCESSORIES COLLECTION ---
$products = [
    201 => [
        ...
        "category" => "Gen-Z",
        "brand" => "Metal Works",
        "description" => "Trendy layered chain necklace set with pendant details. Perfect for adding an edgy touch to any outfit with mixed metal finishes.",
        "types" => ["Layered Set", "Single Chain", "Choker Style"],
        "finish" => ["Silver", "Gold", "Gunmetal", "Rose Gold"],
        "style" => ["Layered", "Edgy", "Statement"],
        "features" => ["Adjustable Length", "Hypoallergenic", "Premium Finish", "Lightweight"],
        "material" => ["Stainless Steel", "Alloy Pendants"],
        "color_images" => [
            "Silver" => "images/as1.jpg",
            "Gold" => "images/as1.jpg",
            "Gunmetal" => "images/as1.jpg"
        ]
    ],
    202 => [
    "title" => "Chunky Resin Rings",
    "price" => 899,
    "img" => "images/as2.webp",
    "category" => "Gen-Z",
    "brand" => "Crystal Craft",
    "description" => "Bold chunky resin rings adorned with sparkling gems and rhinestones. Perfect for making a statement and adding glam to any outfit.",
    "sizes" => ["Adjustable", "Size 6", "Size 7", "Size 8", "Size 9"],
    "colors" => ["Clear with Gems", "Black with Rhinestones", "Pink with Pearls", "Blue with Crystals"],
    "style" => ["Chunky", "Statement", "Glam", "Bold"],
    "features" => ["Sparkling Gems", "Adjustable Fit", "Lightweight Resin", "Hypoallergenic"],
    "material" => ["Resin", "Glass Gems", "Rhinestones", "Alloy Base"],
    "color_images" => [
        "Clear with Gems" => "images/as2.webp",
        "Black with Rhinestones" => "images/as2.webp",
        "Pink with Pearls" => "images/as2.webp"
    ]
],
    203 => [
    "title" => "Tulip Bouquet Hair Claw Clip",
    "price" => 699,
    "img" => "images/as3.jpg",
    "category" => "Gen-Z",
    "brand" => "Floral Charm",
    "description" => "Beautiful tulip bouquet hair claw clip with realistic flower design. Perfect for adding a touch of elegance and nature to your hairstyle.",
    "sizes" => ["One Size"],
    "colors" => ["Pink Tulips", "White Tulips", "Purple Tulips", "Mixed Bouquet", "Pastel Tulips"],
    "style" => ["Floral", "Elegant", "Feminine", "Nature-inspired"],
    "features" => ["Realistic Flower Design", "Strong Grip", "Smooth Edges", "Lightweight"],
    "material" => ["Acrylic Flowers", "Metal Spring", "Plastic Base"],
    "color_images" => [
        "Pink Tulips" => "images/as3.jpg",
        "White Tulips" => "images/as3.jpg",
        "Purple Tulips" => "images/as3.jpg"
    ]
],
    204 => [
        ...
        "sizes" => ["One Size"],
        "colors" => ["Assorted Colors", "Neon Pack", "Pastel Pack", "Graphic Print"],
        "style" => ["Colorful", "Patterned", "Fun", "Bold"],
        "features" => ["Multiple Designs", "Comfortable Fit", "Breathable Fabric", "Durable"],
        "material" => ["Cotton", "Nylon", "Elastane"],
        "color_images" => [
            "Assorted Colors" => "images/as4.webp",
            "Neon Pack" => "images/as4.webp",
            "Pastel Pack" => "images/as4.webp"
        ]
    ],
    205 => [
        "title" => "Crossbody Bag",
        ...
        "category" => "Gen-Z",
        "brand" => "Bag Culture",
        "description" => "Trendy crossbody bag with adjustable strap and multiple compartments. Perfect for carrying essentials in style.",
        "sizes" => ["One Size"],
        "colors" => ["Black", "Brown", "Navy", "Green", "Multi-color"],
        "style" => ["Crossbody", "Utility", "Streetwear"],
        "features" => ["Adjustable Strap", "Multiple Pockets", "Secure Closure", "Lightweight"],
        "material" => ["Nylon", "Polyester", "Metal Hardware"],
        "color_images" => [
            "Black" => "images/as5.jpg",
            "Brown" => "images/as5.jpg",
            "Navy" => "images/as5.jpg"
        ]
    ],
    206 => [
        "title" => "Hair Claw Clips Set",
        "price" => 499,
        "img" => "images/as6.webp",
        "category" => "Gen-Z",
        "brand" => "Hair Vibes",
        "description" => "Set of trendy hair claw clips in various sizes and colors. Perfect for creating stylish hairstyles with ease.",
        "sizes" => ["Small", "Medium", "Large"],
        "colors" => ["Clear", "Tortoise", "Black", "Pastel Set", "Neon Set"],
        "style" => ["Minimal", "Trendy", "Versatile"],
        "features" => ["Strong Grip", "Smooth Edges", "Multiple Sizes", "Durable"],
        "material" => ["Acrylic", "Metal Spring"],
        "color_images" => [
            "Clear" => "images/as6.webp",
            "Tortoise" => "images/as6.webp",
            "Pastel Set" => "images/as6.webp"
        ]
    ],
    207 => [
        ...
        "category" => "Gen-Z",
        "brand" => "Ring Theory",
        "description" => "Set of delicate stacking rings with various designs. Perfect for creating personalized ring combinations.",
        "sizes" => ["Adjustable"],
        "colors" => ["Silver", "Gold", "Rose Gold", "Mixed Metals"],
        "style" => ["Delicate", "Stackable", "Minimal"],
        "features" => ["Adjustable Size", "Hypoallergenic", "Delicate Design", "Mix & Match"],
        "material" => ["Stainless Steel", "Alloy"],
        "color_images" => [
            "Silver" => "images/as7.webp",
            "Gold" => "images/as7.webp",
            "Mixed Metals" => "images/as7.webp"
        ]
    ],
    208 => [
        ...
        "category" => "Gen-Z",
        "brand" => "Bead Culture",
        "description" => "Colorful beaded bracelet set with various patterns and charms. Perfect for layering and personal expression.",
        "sizes" => ["Adjustable"],
        "colors" => ["Multi-color", "Pastel", "Neon", "Earth Tones"],
        "style" => ["Beaded", "Layered", "Colorful"],
        "features" => ["Adjustable", "Various Beads", "Charm Details", "Stackable"],
        "material" => ["Glass Beads", "Elastic Cord", "Metal Charms"],
        "color_images" => [
            "Multi-color" => "images/as8.jpg",
            "Pastel" => "images/as8.jpg",
            "Neon" => "images/as8.jpg"
        ]
    ],
    209 => [
        ...
        "category" => "Gen-Z",
        "brand" => "Sole Society",
        "description" => "Trendy chunky platform loafers with bold design and comfortable cushioning. Perfect for elevating your street style.",
        "sizes" => ["6", "7", "8", "9", "10"],
        "colors" => ["Black", "Brown", "White", "Leopard Print"],
        ...
        "color_images" => [
            "Black" => "images/as9n.jpg",
            "Brown" => "images/as9n.jpg",
            "White" => "images/as9n.jpg"
        ]
    ],
    210 => [
        "title" => "Transparent Phone Case",
        "price" => 399,
        "img" => "images/as10.webp",
        "category" => "Gen-Z",
        "brand" => "Case Culture",
        "description" => "Clear transparent phone case with fun sticker designs. Perfect for personalizing your phone while keeping it protected.",
        "sizes" => ["Universal"],
        "colors" => ["Clear", "Smoke", "Pink Tint", "Blue Tint"],
        "style" => ["Minimal", "Customizable", "Modern"],
        "features" => ["Crystal Clear", "Wireless Charging Compatible", "Drop Protection", "Sticker Set Included"],
        "material" => ["TPU", "Polycarbonate"],
        "color_images" => [
            "Clear" => "images/as10.webp",
            "Smoke" => "images/as10.webp",
            "Pink Tint" => "images/as10.webp"
        ]
    ],
    211 => [
        "title" => "Mini Backpack Purse",
        "price" => 1599,
        "img" => "images/as11.webp",
        "category" => "Gen-Z",
        "brand" => "Urban Gear",
        "description" => "Compact mini backpack purse with multiple compartments. Perfect for hands-free carrying of essentials with style.",
        "sizes" => ["One Size"],
        "colors" => ["Black", "Pink", "Silver", "Camouflage"],
        "style" => ["Mini", "Backpack", "Utility"],
        "features" => ["Adjustable Straps", "Multiple Pockets", "Secure Zipper", "Lightweight"],
        "material" => ["Nylon", "Polyester", "Metal Zippers"],
        "color_images" => [
            "Black" => "images/as11.webp",
            "Pink" => "images/as11.webp",
            "Silver" => "images/as11.webp"
        ]
    ],
    212 => [
        "title" => "LED Light Up Earrings",
        "price" => 699,
        "img" => "images/as12.jpg",
        "category" => "Gen-Z",
        "brand" => "Glow Tech",
        "description" => "Fun LED light up earrings with multiple color modes. Perfect for parties, concerts, and making a statement.",
        "sizes" => ["One Size"],
        "colors" => ["Rainbow", "Blue", "Pink", "Multicolor"],
        "style" => ["Tech", "Statement", "Party"],
        "features" => ["LED Lights", "Multiple Modes", "USB Rechargeable", "Lightweight"],
        "material" => ["Plastic", "LED Components", "Metal Posts"],
        "color_images" => [
            "Rainbow" => "images/as12.jpg",
            "Blue" => "images/as12.jpg",
            "Pink" => "images/as12.jpg"
        ]
    ]
];
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title">Gen-Z Accessories Collection</h1>
        <p class="page-subtitle">Discover trendy accessories and statement pieces for the new generation</p>
    </div>
</div>
