...
// --- MEN TSHIRTS SECTION ---
$products = [
101 => ["title" => "denim tshirt", "price" => 1199, "img" => "images/m1.jpg", "category" => "Women", "brand" => "Anouk"],

102 => ["title" => "Louis Philippe Classic T-Shirt", "price" => 1999, "img" => "images/m2.webp", "category" => "Men", "brand" => "Louis Philippe"],

103 => ["title" => "White Cotton Crew Neck T-Shirt", "price" => 899, "img" => "images/m3.jpg", "category" => "Men", "brand" => "Allen Solly"],

104 => ["title" => "Roadster Checked Graphic T-Shirt", "price" => 749, "img" => "images/m4.jpg", "category" => "Men", "brand" => "Roadster"],

105 => ["title" => "Peter England Solid Polo T-Shirt", "price" => 3499, "img" => "images/m5.jpg", "category" => "Men", "brand" => "Peter England"],

106 => ["title" => "Adidas Black Sports T-Shirt", "price" => 1499, "img" => "images/m6.webp", "category" => "Men", "brand" => "Adidas"],

107 => ["title" => "Levi's Denim Look T-Shirt", "price" => 2499, "img" => "images/m7.jpg", "category" => "Men", "brand" => "Levi's"],

108 => ["title" => "t-shirt", "price" => 4999, "img" => "images/m8.jpg", "category" => "Men", "brand" => "Manyavar"],

109 => ["title" => "Adidas Black Sports T-Shirt", "price" => 499, "img" => "images/m9.jpg", "category" => "Beauty", "brand" => "adidas"],

110 => ["title" => "Bewakoof Graphic Printed T-Shirt", "price" => 1999, "img" => "images/m10.webp", "category" => "Men", "brand" => "Bewakoof"],

111 => ["title" => "GenZ Oversized Cotton T-Shirt", "price" => 1299, "img" => "images/m11.webp", "category" => "Men", "brand" => "GenZ"],

112 => ["title" => "trending tshirt", "price" => 999, "img" => "images/m12.jpg", "category" => "Home", "brand" => "HomeStyle"],

113 => ["title" => "Cool tshirt", "price" => 799, "img" => "images/m13.webp", "category" => "Kids", "brand" => "Casio"],

114 => ["title" => "trending tshirt", "price" => 599, "img" => "images/m14n.webp", "category" => "Beauty", "brand" => "shirts"],

115 => ["title" => "H&M Floral Summer tshirt", "price" => 1799, "img" => "images/m15.jpg", "category" => "Women", "brand" => "H&M"],

116 => ["title" => "Allen Solly Blue Polo T-Shirt", "price" => 1399, "img" => "images/m16.webp", "category" => "Men", "brand" => "Allen Solly"],
];
...
<head>
    ...
    <title><?= $currentProduct ? $currentProduct['title'] . ' - Myntra Clone' : 'Men T-Shirts - Myntra Clone' ?></title>
...
<div class="page-header">
    <div class="container">
        ...
        <h1 class="page-title">Men's T-Shirts</h1>
        <p class="page-subtitle">Discover the latest collection of formal and casual t-shirts for men</p>
    </div>
</div>
...
<div class="container my-4">
    <a href="tshirt.php" class="back-to-products"><i class="fa fa-arrow-left"></i> Back to T-Shirts</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="product-detail-description">
                    Premium quality t-shirt with perfect fit. Ideal for casual wear and everyday occasions.
                </div>
                ...
                <div class="product-detail-specs">
                    ...
                    <div class="spec-item">
                        ...
                        <div class="spec-value">
                            <span class="color-option" onclick="selectColor(this)">Black</span>
                            <span class="color-option" onclick="selectColor(this)">White</span>
                            <span class="color-option" onclick="selectColor(this)">Blue</span>
                        </div>
                    </div>
